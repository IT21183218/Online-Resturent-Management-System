    ...
    <div>        
        <div className='w-xl h-40 px-6 py-12 bg-backGrnd border-black border rounded-2xl flex flex-row items-center gap-10'>
            ...
            <div className='w-24 h-24 bg-purple-500 border-black border rounded-full'>
                <img className='w-24 h-24 rounded-full object-cover ' src={item.profile} alt={item.profile}/>
            </div>
            ...
            <div className='flex flex-col gap-0'>
                ...
                <div className='text-left px-2 py-1 text-sm font-semibold flex flex-row items-center gap-5'>
                    <span>Date Time : </span><span>{item.date}</span>
                </div>
            ...
            <div className='flex flex-row gap-4'>
                <Link to={"/Finance/Transaction/update"} state={{details: item}}>
                ...
                <Link to={"/Finance/Transaction/delete"+item.tID}>       
                    <button onClick={(e)=>{
                            ...
                            if(window.confirm("Are you sure you want to delete this item")){
                              ...
                              axios.delete("http://localhost:8000/transaction/delete",{data : p}).then((result)=>{
                                setItemList([])
                                goBack();
                              })
                            }
